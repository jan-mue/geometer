...
from .curve import AlgebraicCurve, Conic, Circle, Quadric, Ellipse, Sphere
...
from .shapes import Polytope, Segment, Polygon, Simplex, Triangle, Rectangle, RegularPolygon, Cuboid
