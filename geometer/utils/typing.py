...
ScalarInteger: TypeAlias = Union[int, np.int_]
IntegerSlice1D: TypeAlias = Union[slice, Sequence[int], Sequence[np.int_], npt.NDArray[np.int_]]
IntegerIndex1D: TypeAlias = Union[ScalarInteger, IntegerSlice1D]
ScalarBoolean: TypeAlias = Union[bool, np.bool_]
BooleanSlice1D: TypeAlias = Union[slice, Sequence[bool], Sequence[np.bool_], npt.NDArray[np.bool_]]
BooleanIndex1D: TypeAlias = Union[ScalarBoolean, BooleanSlice1D]
